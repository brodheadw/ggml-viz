#!/bin/bash
# Linux GGML Visualizer Injection Script
# Usage: ./inject_linux.sh <command> [args...]
...
SHARED_LIB="$BUILD_DIR/src/libggml_viz_hook.so"
...
echo "=============================================="
echo "🚀 GGML Visualizer Injection (Linux)"
echo "=============================================="
...
# Set up LD_PRELOAD environment for Linux
export LD_PRELOAD="$SHARED_LIB${LD_PRELOAD:+:$LD_PRELOAD}"
